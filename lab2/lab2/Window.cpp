...
namespace
{
	...
	const glm::vec3 ORANGE = { 1.f, 0.7f, 0.f };
	const glm::vec3 BLUE = { 0.f, 0.004f, 1.f };
	...
	, m_sunlight(GL_LIGHT0)
{
	...
	m_cube.SetFaceColor(SnubCube::Top, YELLOW);
	m_cube.SetFaceColor(SnubCube::Bottom, WHITE);
	m_cube.SetFaceColor(SnubCube::Left, GREEN);
	m_cube.SetFaceColor(SnubCube::Right, ORANGE);
	m_cube.SetFaceColor(SnubCube::Front, BLUE);
	m_cube.SetFaceColor(SnubCube::Back, RED);
