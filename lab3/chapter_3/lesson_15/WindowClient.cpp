...
CWindowClient::CWindowClient(CWindow &window)
    ...
    , m_paraboloidObj(SPHERE_PRECISION, SPHERE_PRECISION)
    ...
    , m_programFixed(CShaderProgram::fixed_pipeline_t())
{
    ...
    m_paraboloidMat.SetDiffuse(DARK_BLUE_RGBA);
    m_paraboloidMat.SetAmbient(DARK_BLUE_RGBA * AMBIENT_SCALE);
